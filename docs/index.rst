...
For the most recent documentation, please refer to the CODED guidebook, available in `English`_ and `French`_. 
...
- Running CODED using the Forest Disturbance Mapping GUI (`English`_ , `French`_).
